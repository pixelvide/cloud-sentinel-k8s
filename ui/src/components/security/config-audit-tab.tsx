...
import { securityApi, ConfigAuditReport, ConfigAuditCheck } from "@/api/security"
...
export function ConfigAuditTab({ namespace, kind, name }: ConfigAuditTabProps) {
            ...
            <div className="p-6">
                <Alert variant="default" className="bg-blue-50 dark:bg-blue-950/30 border-blue-200 dark:border-blue-800">
                    ...
                    <AlertDescription className="text-blue-700 dark:text-blue-400 ml-2 mt-2">
                        <p className="mb-4">
                            Config audit scanning requires the Trivy Operator to be installed in your cluster.
                        </p>
    ...
    if (isLoading) {
        return <div className="p-6 text-center text-muted-foreground">Loading config audit reports...</div>
    }
    ...
    if (!reports?.items || reports.items.length === 0) {
        return (
            <div className="flex flex-col items-center justify-center p-12 text-center border rounded-lg bg-muted/30">
                ...
                <h3 className="text-lg font-semibold text-foreground">No Config Audit Reports Found</h3>
                <p className="text-sm text-muted-foreground mt-2 max-w-sm">
                    Trivy Operator hasn't scanned this resource yet, or no configuration issues were found.
                </p>
            </div>
        )
    }
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <p className="text-xs text-muted-foreground">Configuration compliant</p>
                    </CardContent>
                </Card>
            </div>
